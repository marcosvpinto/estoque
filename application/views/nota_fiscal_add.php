<?php 
	...
	echo form_input('numero_nota', '', 'title="Número da Nota Fiscal" size="15" class="required input-block-level input-xlarge" placeholder="Nota Fiscal"');
	echo br();
	...
	echo form_input('data_nota', '', 'title="Data da Nota Fiscal" id="data_nota" size="15" class="required input-block-level input-xlarge" placeholder="Data da Nota"');
